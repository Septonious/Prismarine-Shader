...
vec3 lightMorning    = vec3(LIGHT_MR * (1.25 - sqrt(timeBrightness) * 0.25),   LIGHT_MG,   LIGHT_MB)   * LIGHT_MI / 255.0;
vec3 lightDay        = vec3(LIGHT_DR,   LIGHT_DG,   LIGHT_DB)   * LIGHT_DI / 255.0;
vec3 lightEvening    = vec3(LIGHT_ER * (1.25 - sqrt(timeBrightness) * 0.25),   LIGHT_EG,   LIGHT_EB)   * LIGHT_EI / 255.0;
